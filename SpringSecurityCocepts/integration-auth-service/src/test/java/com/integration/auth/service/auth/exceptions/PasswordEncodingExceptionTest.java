...
class PasswordEncodingExceptionTest {

	@Test
	void testConstructorWithErrors() {
		Errors errors = new Errors("Target", "Message", 123);
		PasswordEncodingException exception = new PasswordEncodingException(errors);
	...
	void testConstructorWithExceptionAndErrors() {
		...
		Errors errors = new Errors("Target", "Message", 123);
		PasswordEncodingException exception = new PasswordEncodingException(ex, errors);
